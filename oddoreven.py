...
while True:
    ...
    if k == 27:
        ...
        if bow == 1:
                ...
                print('YOU',count_defects+1)
                print('COMPUTER',x)
                print('YOU',count_defects+1)
                print('COMPUTER',x)
                window = Tk()

                window.title("SCORE BOARD")


                lb1 = Label(window, text="YOUR GESTURE")
                lb2 = Label(window, text=count_defects+1)
                lb3 = Label(window, text="COMPUTER GESTURE")
                lb4 = Label(window, text=x)


                lb1.grid(column=0, row=0)
                lb2.grid(column=25, row=0)
                lb3.grid(column=0, row=18)
                lb4.grid(column=13, row=18)
